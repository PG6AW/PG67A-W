...
books_frame = tk.Frame(window, relief=tk.RAISED, borderwidth=2, bg="yellow")
books_frame.pack(pady=20)

books_label = tk.Label(books_frame, text="Search Books", font=("bold", 16), bg="yellow")
books_label.pack(pady=10)

id_label = tk.Label(books_frame, text="ID:", font=("bold", 12), bg="yellow")
id_label.pack()
id_entry = tk.Entry(books_frame, font=("bold", 12))
id_entry.pack()

title_label = tk.Label(books_frame, text="Title:", font=("bold", 12), bg="yellow")
title_label.pack()
title_entry = tk.Entry(books_frame, font=("bold", 12))
title_entry.pack()

author_label = tk.Label(books_frame, text="Author:", font=("bold", 12), bg="yellow")
author_label.pack()
author_entry = tk.Entry(books_frame, font=("bold", 12))
author_entry.pack()

pages_label = tk.Label(books_frame, text="Pages:", font=("bold", 12), bg="yellow")
pages_label.pack()
pages_entry = tk.Entry(books_frame, font=("bold", 12))
pages_entry.pack()

instances_label = tk.Label(books_frame, text="Instances:", font=("bold", 12), bg="yellow")
instances_label.pack()
instances_entry = tk.Entry(books_frame, font=("bold", 12))
instances_entry.pack()

search_books_button = tk.Button(books_frame, text="Search", font=("bold", 12), command=search_books)
search_books_button.pack(pady=10)

users_frame = tk.Frame(window, relief=tk.RAISED, borderwidth=2, bg="yellow")
users_frame.pack(pady=20)

users_label = tk.Label(users_frame, text="Search Users", font=("bold", 16), bg="yellow")
users_label.pack(pady=10)

user_id_label = tk.Label(users_frame, text="ID:", font=("bold", 12), bg="yellow")
user_id_label.pack()
user_id_entry = tk.Entry(users_frame, font=("bold", 12))
user_id_entry.pack()

username_label = tk.Label(users_frame, text="Username:", font=("bold", 12), bg="yellow")
username_label.pack()
username_entry = tk.Entry(users_frame, font=("bold", 12))
username_entry.pack()

password_label = tk.Label(users_frame, text="Password:", font=("bold", 12), bg="yellow")
password_label.pack()
password_entry = tk.Entry(users_frame, font=("bold", 12))
password_entry.pack()

borrowed_ids_label = tk.Label(users_frame, text="Borrowed IDs:", font=("bold", 12), bg="yellow")
borrowed_ids_label.pack()
borrowed_ids_entry = tk.Entry(users_frame, font=("bold", 12))
borrowed_ids_entry.pack()

days_remaining_label = tk.Label(users_frame, text="Days Remaining:", font=("bold", 12), bg="yellow")
